...
set JARPATH=%APP_HOME%\lib\spring-petclinic-data-jdbc-2.1.0.BUILD-SNAPSHOT.jar

@rem Execute spring-petclinic-data-jdbc
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SPRING_PETCLINIC_DATA_JDBC_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
